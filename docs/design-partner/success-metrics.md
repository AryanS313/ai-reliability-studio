...
**Delivery context (17 September 2026):** native `2026.09.17.1` is merged and live; branch/PR/main checks passed. The primary site’s custom preparation, public HTTPS transport, two synthetic runs/comparison, download controls and two-tab reset were observed. These are bounded engineering observations, not customer activations, real-assistant quality, achieved pilot targets or recurring use. Full owner acceptance requires approved real-assistant/account access and independent user/domain/manual-picker evidence. The [release review](release-review.md), [hosted workflow review](hosted-workflow-review.md) and [living product history](../PRODUCT_EVOLUTION.md) retain exact scope. All 36 measurement contracts and their historical/unmeasured baselines below remain unchanged; customer and commercial outcomes remain unmeasured.
