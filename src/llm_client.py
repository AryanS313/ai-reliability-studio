...
def _http_client(*, transport: httpx.BaseTransport | None = None) -> httpx.Client:
    ...
    # Only explicit provider destinations are supported; never inherit proxies/netrc.
    return httpx.Client(
    ...
    *,
    ...
    if config.APP_ACCESS_MODE == "public-demo":
        return _failure(
            ...
            message="The public demo runs synthetic examples only. Use a private workspace to connect a real assistant.",
            final_prompt=final_prompt,
