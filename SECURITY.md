...
See [Security and privacy](docs/SECURITY_AND_PRIVACY.md) for exact configuration, data handling, and verification limits, and [the design-partner review](docs/design-partner/security-review.md) for findings and tests. The owner-authorized September 17 correction is merged and observed on the primary site; [release receipts](docs/design-partner/hosted-workflow-review.md) distinguish that delivery from outstanding account, usability and infrastructure assurance.
